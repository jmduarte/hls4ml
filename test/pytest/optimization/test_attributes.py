...
def test_attributes():
    ...
    assert model_attributes['conv2d'].optimizable is False
    ...
    assert model_attributes['flatten'].optimizable is False
    ...
    assert model_attributes['dense'].optimizable is False
    ...
    assert model_attributes['dense'].args['hls4ml_attributes'].reuse_factor == default_reuse_factor
    ...
    assert model_attributes['relu'].optimizable is False
