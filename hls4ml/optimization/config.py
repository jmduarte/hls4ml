...
3. Pattern:
    - Pruning: Y
    - Weight sharing: Y
    - Description: Zeroes out or quantizes all the weights in a groups.
       Groups are determined by a variable, n, and every n-th weight in the flattened weight tensor is collected and stored in the same group
