from hls4ml.backends.backend import (Backend, get_available_backends,
...
from hls4ml.backends.vivado_accelerator.vivado_accelerator_backend import \
    VivadoAcceleratorBackend
from hls4ml.backends.vivado_accelerator.vivado_accelerator_config import \
